...
```{r plot_wealth, echo=FALSE,fig.cap="\\label{fig:figs}Variation of $\\tau$"}
plot(aggregate.by.tau$tau,aggregate.by.tau$mean__wealth__of_investors,type="l",col="red",
     xlab="tau",ylab="",main="Dependence of wealth on tau")
par(new = T)
plot(aggregate.by.tau$tau,aggregate.by.tau$standard_deviation__wealth__of_investors,type="l",col="blue",
