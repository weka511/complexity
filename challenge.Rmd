...
Figure \ref{fig:figs} shows the effect of varying $\tau$.

```{r plot_wealth, echo=FALSE,fig.cap="\\label{fig:figs}Variation of accumulated wealth with $\\tau$",warning=FALSE, out.width='.49\\linewidth', fig.width=4, fig.height=4,fig.show='hold',fig.align='center'}
tau.data<-get.tau()
...
plot(tau.agg11$tau,tau.agg11$mean__wealth__of_investors,type="l",col="blue",lty=1,
     xlab="",ylab="",yaxt='n',main = "Mean Wealth")
par(new=TRUE)
...
plot(tau.agg11$tau,tau.agg11$standard_deviation__wealth__of_investors,type="l",col="blue",lty=1,
     xlab="",ylab="",yaxt='n',main="Standard Deviation")
par(new=TRUE)
