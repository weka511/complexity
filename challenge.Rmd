...
I used R to analyze the data, and a RMarkdown script to present the results, following the excellent advice of Rosanna van Hespen[@vanhespen2016thesis]. The model was executed by Behaviouspace, `r n.repetitions` repetitions, using the cobfigurations described in Table \ref{table:configs}

```{r echo=FALSE,results='asis'}
library(knitr)
kable(get.configurations(tau.data),caption="\\label{table:configs}Foo")
