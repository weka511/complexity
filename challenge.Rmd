...
I used R to analyze the data, and an RMarkdown script to present the results, following the excellent advice of Rosanna van Hespen[@vanhespen2016thesis]. The model was executed by Behaviourspace, which performed `r n.repetitions` repetitions, varying the parameters listed in Table \ref{table:configs}
