...
```
```{r echo=FALSE,fig.cap="\\label{fig:plot_individual}Growth of wealth",warning=FALSE, out.width='.49\\linewidth', fig.width=4, fig.height=4,fig.show='hold',fig.align='center',fig.pos = 'p'}
my.individual.details<-read.csv('C:/Users/Weka/201804/Experiments/even more details.csv')
plot.individuals(my.individual.details)
