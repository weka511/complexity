...
\newglossaryentry{gls:autocatalytic:set}{
	...
	description={An autocatalytic set is defined as
		...
		\begin{enumerate}
			...
			from the set itself\cite{sfi2020}
\end{enumerate}}}
\newglossaryentry{gls:autocatalysis}{
	name={autocatalysis},
	description={Chemical self production: the ability of a set of chemical species to make more of that same set, by undergoing a series of chemical 	reactions\cite{sfi2020}}}
