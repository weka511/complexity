...
The \gls{gls:price:equation}\cite{gardner2020price} is a nice way to look at these two processes. It looks at the variation in survival when something happens.
\begin{align*}
