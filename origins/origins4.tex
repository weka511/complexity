...
Autocalaysis vs replication: at first site similar, but replication exhibits diversity. Template replicators\cite{von1986self}\cite{virgo2012evolvable}. Main problem: the monomers
have to be quite complicated
to avoid side reactions

Figure \ref{fig:EigensParadox} illustrates Eigen's paradox \cite{eigen1971selforganization}.
\begin{itemize}
