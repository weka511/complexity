...
Autocalaysis vs replication: at first site similar, but replication exhibits diversity. Template replicators. Main problem: the monomers
...
\begin{itemize}
	...
	information stored in composition of protocell instead
	(Segre et al., Vasas et al.)
\end{itemize}
