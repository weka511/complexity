...
\begin{figure}[H]
	\caption{The Modern Cell gives rise to the Central Dogma: this process of going from DNA to RNA to proteins is exhibited in all forms of modern life.}
...
\end{itemize}
\begin{figure}[H]
	\caption{\gls{gls:RNA}  can store and pass down genetic information similar to \gls{gls:DNA} }\label{fig:RNA_WorldTheory}
...
\begin{figure}[H]
	\caption[The dominant paradigm: the RNA World]{The dominant paradigm: the RNA World--a tRNA molecule after \cite{x3dna.org}}\label{fig:RNA} 
