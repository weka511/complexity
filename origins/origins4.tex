...
Nobody has been able to show that RNA can catalyze its own template-directed reproduction. Howver, some RNA molecules can catalyze the formation of other RNA. They can form cooperative moleculr networks, in which each catalyzes the formation of other RNAs. The first example is shown in Figure \ref{fig:MutualCatalysis1}\cite{patzke2007self}.

\begin{figure}[H]
	\caption{Mutual Catalysis from the lab of G\"unter von Kiedrowski}\label{fig:MutualCatalysis1}
	\includegraphics[width=0.9\textwidth]{MutualCatalysis1}
\end{figure}

\cite{vaidya2012spontaneous}
\begin{figure}[H]
	\caption{Mutual Catalysis from Portland}\label{fig:MutualCatalysis2}
	\includegraphics[width=0.9\textwidth]{MutualCatalysis2}
\end{figure}

\cite{wim2017origin}, \cite{hordijk2017chasing}, \cite{wim2019wandering},   \cite{ashkenasy2004design}, \cite{hordijk2012structure}, \cite{sousa2015autocatalytic}
...
\begin{itemize}
	...
	\item Primary succession by evolution of niche specialists is frequently observed in the lab. Figure \ref{fig:NicheSpecialization}\cite{rainey1998adaptive} shows the evolution of P. fluorescens to give different shaped colonies that specialize in differwnt areas 
\end{itemize}

\begin{figure}[H]
	\caption{Microbial Facilitation}\label{fig:EColiEvolution}
	\includegraphics[width=0.9\textwidth]{EColiEvolution}
\end{figure}

\begin{figure}[H]
	\caption{Microbial Facilitation}\label{fig:NicheSpecialization}
