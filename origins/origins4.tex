...
%opening
\title{Notes from Origins of \gls{gls:life}\\Week4: Early Life}
\author{Simon Crase}
...
\begin{abstract}
   These are my notes from Week 4 of the \gls{gls:SFI} Origins of Life Course\cite{sfi2019}. The course aims to push the field of Origins of Life research forward by bringing new and synthetic thinking to the question of how life emerged from an abiotic world.\\
