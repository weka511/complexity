...
\begin{figure}[H]
	\begin{center}
		\caption[A system may be stable in both sense, either, or none]{A system may be stable in both sense, either, or none. Original course image; energy plot added by Michael McGuffin--used by permission.}\label{fig:VisualizingStability}
