...
\begin{itemize}
	\item Water is good at interacting with polar or charged
	molecules
...
Oil in Water
\begin{itemize}
	\item Figure \ref{fig:Hexane} depicts the formation of clathrate structures – water cannot form hydrogen bonds with oils.
...
\begin{figure}[H]
	...
	\begin{subfigure}{.6\textwidth}
		...
		\caption{Oxygen atoms are shown	in red. }
		\label{fig:clathrate}
	\end{subfigure}
\end{figure}
