...
We'll look at how chemoautotrophy evolved--Figure \ref{fig:ClassificationEnergyGeneration}.
\begin{figure}[H]
...
\begin{figure}[H]
	\caption{ModernRedux} \label{fig:ModernRedux} 
	\includegraphics[width=0.9\textwidth]{ModernRedux}
\end{figure}

\begin{figure}[H]
	\caption{PrimordialRedox} \label{fig:PrimordialRedox} 
