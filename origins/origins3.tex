...
\section{\gls{gls:DNA} as Information}
Lecturer: Michael Lachmann, \gls{gls:SFI}

\subsection{\gls{gls:DNA} Modification}

\begin{figure}[H]
	\begin{center}
		\caption[\gls{gls:DNA}, pairing G/C, A/T.]{\gls{gls:DNA}, pairing G/C, A/T. Mutation rate $10^{-10}$ errors per rep.base. }\label{fig:DNA}
...
\begin{figure}[H]
	\caption{The only chemical difference between \gls{gls:DNA} and \gls{gls:RNA} is the extra oxygen in \gls{gls:RNA}. It causes \gls{gls:RNA} to be more active then \gls{gls:DNA}.}\label{fig:NucleotideDNARNA} 
