...
Figure \ref{fig:LUCA_Environment} depicts a \textit{proposed} reconstruction of the metabolism of \gls{gls:LUCA}\cite{weiss2016physiology}. Since early Earth was anoxic, pathways do not use oxygen directly.
\begin{figure}[H]
	\caption{Proposed main metabolic pathways of LUCA, near hydrothermal vent. } \label{fig:LUCA_Environment} 
