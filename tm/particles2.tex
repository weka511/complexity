...
\begin{figure}[H]
	\begin{center}
		\caption{Decay of a $\Delta_\frac{3}{2}$. Quarks can't go off on their own, so we need a quark-antiquark pair to balance. $\Delta_\frac{3}{2}\rightarrow p +\pi^+$: there is enough energy left.}\label{fig:decay:dalta}
...
\url{https://youtu.be/yy989li6xgY?t=3828}
