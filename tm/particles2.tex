...
Goldstone boson disappears. The Goldstone boson is a slowly varying $\alpha$. We can make $\alpha$ vary by gauge transformation, which surely involves the Goldstone boson. But gauge transformation is a symmetry; it doesn't change energy and remains in the ground state. The Goldstone boson disappears, and the massless photon is replaced by a massive one. The Higgs boson now has a mass. That is the Higgs phenomenon.
...
There is still the thing that we froze in an approximation. What if we hot it hard enough to set it oscillating in radial direction? These are the Higgs bosons.
 
\url{https://youtu.be/qzGY-BrCUgA?t=1434}
