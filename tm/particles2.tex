...
\begin{appendices}
	...
	Figure \ref{fig:2-a3-zilch-Z} shows a Z-boson exchanging zilch with the condensate, so it oscillates between Z and Ziggs, thereby getting mass. This is the Brout-Englert-Higgs phenomenon.
