...
\begin{itemize}
	...
	\item $\frac{3}{2}$. $uuu$ and $ddd$, $\uparrow\uparrow\uparrow$, $\downarrow\downarrow\downarrow$. There are 4 states for isospin $\frac{3}{2}$. NB, this $\Delta_\frac{3}{2}$ differs from the nucleon, as all spins are aligned.
\end{itemize}
