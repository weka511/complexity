...
\begin{appendices}
	...
	\begin{figure}[H]
		\caption[Spontaneous breaking of chiral symmetry]{Spontaneous breaking of chiral symmetry: electron exchanging zilch with the condensate via Ziggs bosons}\label{fig:2-a3-zilch}
