...
\begin{figure}[H]
	\begin{center}
		\caption{Running charge increasing logarithmically with $\frac{1}{R}$}\label{fig:2-10-effective-charge}
		\includegraphics[width=0.8\textwidth]{2-10-effective-charge}
	\end{center}
\end{figure}

If you scatter at low energy, charge, and hence scattering, is reduced.

\url{https://youtu.be/QD8SEcoFyAw?t=3800}
