...
In (eq:fermion:Higgs) and Figure \ref{fig:2-9-Higgs-boson} we see that RH can turn into LH + Higgs. When Higgs is found we want to verify the relative rates of different Higgs interactions. 
...
Lagrangian for Dirac Equation.
 ...
 \begin{align*}
	...
	=& \bar{\Psi}\big(\gamma_\mu \partial_\mu +m  \big) \Psi
\end{align*}

\url{https://youtu.be/QD8SEcoFyAw?t=581}
\begin{appendices}
