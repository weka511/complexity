...
\begin{table}[H]
	\begin{center}
		\caption{Let's try 3 $\frac{3}{2}$ spins.}
...
Natural energy of nucleus is a few hundred meV: up and down quarks. To a first approximation, masses are closer to each other, so they are analogous to spin. Thinking of up and down quarks as isomorphic to up and down spins, we invent the concept of isotopic spin.


\url{https://youtu.be/yy989li6xgY?t=1171}

\url{https://youtu.be/yy989li6xgY?t=1755}
