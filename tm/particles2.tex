...
Returning to \ref{fig:2-7-V-quartic}, let's try to identify why there is a massless particle. Ao massless particle corresponds to a long wave staying at minimum. We start with the Lagrangian:
...
\begin{figure}[H]
	\caption{Massive and Massless particles}
	\begin{subfigure}[t]{0.45\textwidth}
...
\url{https://youtu.be/fw4K3sgza04?t=574}
