...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\caption{Spin 0}
		\includegraphics{particles3-3-propagator0}
	\end{subfigure}
\end{figure}
...
Propagator can only depend on distance between $x$ and $y$, and it has to be Lorentz invariant, so it can only depend on the proper distance between the points, whence:
...
\url{https://youtu.be/GzoncJBqeNk?t=1389}
