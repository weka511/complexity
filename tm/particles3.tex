...
Propagators are the amplitude of putting in a particles at one place and taking it out at another place. They are functions of relative coordinates, $\Delta^\mu$. The propagator can also be Fourier transformed, and expressed as a function of 4 other variables, the Fourier conjugate coordinates, i.e. momentum. The Feynman rules are usually expressed in terms of momentum, but we're not going to do that. In momentum space Feynman diagrams become integrals over momentum.

\begin{figure}[H]
	\caption{Simplest Feynman Diagram -- a closed loop}\label{fig:particles3-3-feynman-loop}
	\includegraphics{particles3-3-feynman-loop}
\end{figure}




\url{https://youtu.be/GzoncJBqeNk?t=310}
