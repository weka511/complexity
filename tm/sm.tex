...
\begin{figure}[H]
	\caption{Phase transition at $T_{crit}$}
	\begin{subfigure}[b]{0.45\textwidth}
		\center
...
\begin{figure}[H]
	\caption{Fluid modeled as a lattice}\label{fig:lattice}
