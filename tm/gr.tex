...
\begin{figure}[H]
	\begin{center}
		...
		\end{subfigure}
		\begin{subfigure}[t]{0.45\textwidth}
			\caption{A metre stick falls in. As we saw earlier, it slows down and approaches the Event Horizon asymptotically. As the metre stick faala, the two ends approach each other: this is, in fact, a Lorentz transformation.}\label{fig:gr-6-infalling}
...
\url{https://youtu.be/yv2-KPagCQs?t=1426}

\subsection{Schwarzschild Radius}
\subsection{Black hole event horizon}
