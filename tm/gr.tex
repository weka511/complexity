...
\begin{figure}[H]
	\begin{center}
		\caption{Black hole formed by incoming radiation shell}\label{fig:gr-8-newton-shwartzschild}
		\includegraphics{gr-8-newton-shwartzschild}
	\end{center}
\end{figure}

\url{https://youtu.be/q6j180O9H84?list=PLpGHT1n4-mAvcXwzOIz3dHnGZaQP1LEib&t=3377}
