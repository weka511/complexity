...
\begin{figure}[H]
	\begin{center}
		\caption{New lightlike coordinates: $u\pm = F(t\pm)$}\label{fig:gr-8-F}
		\includegraphics[width=0.5\textwidth]{gr-8-F}
	\end{center}
\end{figure}


\url{https://youtu.be/q6j180O9H84?list=PLpGHT1n4-mAvcXwzOIz3dHnGZaQP1LEib&t=1431}
