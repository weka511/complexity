...
\begin{align*}
	d \tau^2 =& \bigg(1-\frac{2 MG}{c^2 r}\bigg) dt^2 - \frac{1}{\bigg(1-\frac{2 MG}{c^2 r}\bigg)}dr^2 - \frac{1}{c^2} r^2 d\Omega^2
\end{align*}
...
\url{https://youtu.be/quWN1V9jOf0?list=PLpGHT1n4-mAvcXwzOIz3dHnGZaQP1LEib&t=3285}
