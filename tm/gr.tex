...
\begin{appendices}
	...
	\subsubsection{$\Gamma\indices{^t_{\mu\nu}}$}
	...
	\begin{align*}
		...
		=&\frac{1}{2}\nu^\prime(r) \cancel{e^{\nu(r)}}\cancel{e^{-\nu(r)}}\\
		=&\frac{\nu^\prime(r)}{2} \numberthis \label{eq:Gamma:trt}\\
		\Gamma\indices{^t_{tr}}=&\frac{\nu^\prime(r)}{2} \numberthis \label{eq:Gamma:ttr}
	\end{align*}
	\subsubsection{$\Gamma\indices{^r_{\mu\nu}}$}	
	\begin{align*}
	...
	\subsubsection{$\Gamma\indices{^\theta_{\mu\nu}}$}	
	\begin{align*}
		...
		=& \frac{1}{r} \numberthis \label{eq:Gamma:tHrtH}\\
		\Gamma\indices{^\theta_{\theta r}} =&\frac{1}{r} \numberthis \label{eq:Gamma:tHtHr}\\
	...
	\subsubsection{$\Gamma\indices{^\phi_{\mu\nu}}$}
	\begin{align*}
