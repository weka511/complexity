...
\begin{figure}[H]
	\caption{Inside the black hole there is no way out unless you exceed the speed of light. The singularity is shown in red.}\label{fig:gr-8-quadrant1}
	\includegraphics[width=0.5\textwidth]{gr-8-quadrant1}
\end{figure}

\url{https://youtu.be/q6j180O9H84?list=PLpGHT1n4-mAvcXwzOIz3dHnGZaQP1LEib&t=366}
