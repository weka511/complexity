...
\begin{appendices}
	...
	\begin{align*}
		\beta=&1,\delta=2\\
		\implies&\\
		0 =&	\sum_i\big[\partial_i\partial_x h_{iy} - \partial_i\partial_i h_{xy} -  \partial_y\partial_x h_{ii} + \partial_y\partial_i h_{x i}\big]-\partial_0\partial_x h_{0y} + \partial_0\partial_0 h_{xy} +  \partial_y\partial_x h_{00} - \partial_y\partial_0 h_{x 0}\\
		=& - \partial_z\partial_z h_{xy}  + \partial_0\partial_0 h_{xy} \text{, which similarly adds no information}
	\end{align*}
	
	\begin{align*}
		\beta=&1,\delta=3\\
		\implies&\\
		0 =&\sum_i\big[\partial_x\partial_1 h_{iz} - \partial_i\partial_i h_{xz} -  \partial_z\partial_x h_{ii} + \partial_z\partial_i h_{x i}\big]-\partial_0\partial_x h_{0z} + \partial_0\partial_0 h_{xz} +  \partial_z\partial_x h_{00} - \partial_z\partial_0 h_{x 0}\\
		=& - \cancel{\partial_z\partial_z h_{xz}}  + \cancel{\partial_z\partial_z h_{x z}} + \partial_0\partial_0 h_{xz}  - \partial_z\partial_0 h_{x 0}\\
		=& \partial_0\partial_0 h_{xz}  - \partial_z\partial_0 h_{x 0}\\
		=& - k^2 \big[ h^0_{xz}+ h^0_{x0}\big] \sin\big(k(t-z)\big)\\
		0=& h^0_{xz}+ h^0_{x0} \numberthis \label{eq:h:13}
	\end{align*}

	\begin{align*}
		\beta=&2,\delta=2 \text{ adds no information--symmetry with } \beta=1,\delta=1
	\end{align*}
	...
	\begin{align*}
		\beta=&2,\delta=3\\
		\implies&\\
		0=& h^0_{yz}+ h^0_{y0} \text{, similar to (\ref{eq:h:13})} \numberthis \label{eq:h:23}
	\end{align*}
	...
	\begin{align*}
		\beta=&3,\delta=3\\
		\implies&\\
		0 =&\cancel{\partial_z\partial_z h_{zz}} - \cancel{\partial_z\partial_z h_{zz}} -  \partial_z\partial_z \big(h_{xx}+h_{yy}+\bcancel{h_{zz}}\big) + \bcancel{\partial_z\partial_z h_{z z}}-\partial_0\partial_z h_{0z} + \partial_0\partial_0 h_{zz} +  \partial_z\partial_z h_{00} - \partial_z\partial_0 h_{z 0}\\
		=& k^2 \big[\underbrace{h^0_{xx} + h^0_{yy}}_\text{$=0$, from (\ref{eq:h:03})}\underbrace{-h^0_{00}-h^0_{zz}-2h^0_{0z}}_\text{$=0$, from (\ref{eq:h:00})}\big]\sin\big(k(t-z)\big) 
	\end{align*}
