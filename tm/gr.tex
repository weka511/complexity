...
\begin{figure}[H]
	\begin{center}
		\caption{The lightcone, showing timelike vectors.}\label{fig:gr-5-timelike}
		\includegraphics{gr-5-timelike}
	\end{center}
\end{figure}

\begin{itemize}
	\item The proper time is the time read of by a clock moving along a timelike trajectory;
	\item proper distance is the distance measured bt a metre stick along a spacelike trajectory.
\end{itemize} 



\url{https://youtu.be/quWN1V9jOf0?list=PLpGHT1n4-mAvcXwzOIz3dHnGZaQP1LEib&t=502}
