...
\begin{align*}
	...
	\rho(r) =& \int_{1}^{r}\sqrt{\frac{r^\prime}{r^\prime-1}} dr^\prime \text{. We define} \\
	F(\rho) \triangleq &\frac{r-1}{r} \text{ and } \\
	\omega \triangleq & \frac{t}{2} \text{. Our metric becomes }\\
	d\tau^2 =& F(\rho) \rho^2 d\omega^2 - d\rho^2 -r^2(\rho) d\Omega^2\text{, because $s$ is proper distance.}
\end{align*}
...
\begin{align*}
	...
	\lim_{\rho \rightarrow 0}F(\rho) \rho^2=&1
\end{align*}

\url{https://youtu.be/BdYtfYkdGDk?list=PLpGHT1n4-mAvcXwzOIz3dHnGZaQP1LEib&t=1812}
