...
What we can see here is that on the left-hand side,
we have the original image, and on the right-hand side
...
In this case, here, instead of taking the majority vote,
