...
How does model flow as we continue to coarse-grain? This replaces lattice with another  $\beta\rightarrow\frac{3}{8} \log{e^{2\beta} }$. Figure \ref{fig:beta} shows the behaviour of the function $\frac{3}{8} \log{e^{2\beta} }$ and Figure \ref{fig:beta1} shows the evolution of the solution of  $\beta=\frac{3}{8} \log{e^{2\beta} }$. For small $\beta$ the solution evolves to $\beta=0$, and for large $\beta$ to $\beta=\infty$ ($T=0$).


\begin{figure}[H]
	\caption{Solving $\beta=\frac{3}{8} \log{e^{2\beta} }$}
	\begin{subfigure}[t]{0.45\textwidth}
		\caption{$\beta=\frac{3}{8} \log{e^{2\beta} }$}\label{fig:beta}
...
Figure \ref{fig:beta1} shows that the mapping $\beta\rightarrow\frac{3}{8} \log{e^{2\beta} }$ has three fixed points.
\begin{enumerate}
