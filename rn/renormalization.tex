...
S_2 =& \frac{1}{8} \ln{\cosh{4\beta}} \text{ pairwise interactions}\\
S_4 =& \frac{1}{8} \ln{\cosh{4\beta}} - \frac{1}{2} \ln{\cosh{2\beta}} \text{ quartet interaction.}
\end{align*}

Notice that (\ref{eq:coupled:sigmas}) couples $\sigma_1, \sigma_2, \sigma_3, \& \sigma_4$! This includes longer range couplings, such as $\sigma_2, \sigma_3$
